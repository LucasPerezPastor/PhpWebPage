...
// global $viewPort,$contentHead,$listIcons,$links,$externalJavaScripts,$faceBookOpenGraph,$twitterCard,$language;
...
$contentHead=New Contenido(TITLE,DESCRIPTION,'',AUTHOR);
